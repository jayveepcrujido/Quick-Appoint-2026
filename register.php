...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !isset($_POST['validate_only'])) {
    ...
    // Clear OTP verification flag after use (one-time use)
...
<body>
  <div class="register-container">
    ...
    <form method="POST" enctype="multipart/form-data" id="registrationForm">
      ...
      <!-- STEP 2: ACCOUNT INFORMATION & CONSENT -->
...
// Add real-time validation listeners for Step 2
...
// Continuation of the registration form JavaScript
